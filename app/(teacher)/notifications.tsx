...
const notifIcon: Record<string, IconName> = {
  ...
  parent_unreachable: 'call', billing_override_granted_by_assistant: 'clock',
  admin_ticket: 'note', ticket_reply: 'note',
};

/**
 * The teacher / assistant notifications feed. The `/notifications` API is
 * role-agnostic, so this mirrors the student + parent feeds; a tap just marks the
 * row read.
 */
